                                        ...
                                        if line[i + 1] == '.':
                                            ...
                                            if line[i + 1] == '"' or line[i + 1] == '“' or line[i + 1] == '„':
                                                ...
                                                if line[i + 1] == '_' or line[i + 1] == '»':
                                                    if i + 2 != len(line):
                                                        if line[i + 2] == '"' or line[i + 2] == '“' or line[i + 2] == '„':
                                                            write_file.write(line[i] + ' "\n')
                                                            i = i + 2
                                                        else:
                                                            write_file.write(line[i] + '\n')
                                ...
                                if i + 1 == len(line):
                                    ...
                                    if line[i + 1] == ' ':
                                        ...
                                        if line[i + 1] == '-' or line[i + 1] == ',' or line[i + 1] == ':' or line[i + 1] == ';':
                                            ...
                                            write_file.write('" ')
                            elif line[i] == "'" or line[i] == "’" or line[i] == "ʼ":
                                if line[i - 1] != ' ':
                                    write_file.write(' ')
                                if i + 1 < len(line):
                                    if line[i + 1] == ' ':
                                        ...
                                        if line[i + 1] != ',' and line[i + 1] != ';' and line[i + 1] != ':' and line[i + 1] != '.' and line[i + 1] != '!' and line[i + 1] != '?':
                                            write_file.write("' ")
                                        else:
                                            write_file.write("'")
                            elif line[i] == '(':
